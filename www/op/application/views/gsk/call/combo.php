		...
		<form action="" class="panel form-horizontal">
			<div class="panel-body">
				<div class="row form-group">
					...
					<div class="col-sm-8">
						<input type="text" value="<?=date("Y年m月")?>" name="name" disabled class="form-control">
						<input type="hidden" value="<?=$date_id?>" name="dateid" disabled>
					</div>
				</div>
				<div class="row form-group">
				...
				<div class="row form-group">
					...
					<div class="col-sm-6">
						<input type="text" id="price" value="<?=$price?>" name="price" class="form-control" disabled>
					</div>
				</div>
				<div class="row form-group">
					<label class="col-sm-2 control-label">最低消费（元）:</label>
					<div class="col-sm-6">
						<input type="text" id="min_cost" value="<?=$min_cost?>" name="min_cost" class="form-control" disabled>
					</div>
				</div>
				<div class="row form-group">
...
<script>
	$(function(){
		...
		$("#save").click(function(){
			$.ajax({
				url: "/gsk/index.php/gsk_news/call_change_combo",
				type: "GET",
				data: $("form").serialize(),
				dataType: "json",
