<?php
    ...
    //测试环境
     ...
     if( $_CFG['ENV'] == "online" )
     {
         ...
         $_CFG['mongodb_gsk_ol'] = "mongodb://10.128.6.61:20000";
         $_CFG['mongodb_spider'] = "mongodb://192.168.165.240:27017";
         $_CFG['mongodb_op'] = "mongodb://10.128.63.250:27017";
     }
     ...
     $_CFG['DIR_MODEL'] = $_CFG['DIR_ROOT'].'model/';
     $_CFG['DIR_LOG'] = $_CFG['DIR_ROOT'].'log/';
?>
