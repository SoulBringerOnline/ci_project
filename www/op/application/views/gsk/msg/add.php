...
<form action="<?php echo site_url('gsk_msg/msg_add');?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
	 <div class="form-group">
		...
		<div class="col-sm-8">
		  <select name="msgflag" id="msgflag" class="form-control">
			<?php for ($i=0; $i<=64; $i=$i+2) {?>
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
		  <input type="text" class="form-control" id="baseid" name="baseid" placeholder="msg名称 唯一标识 也用于主动发送时候的查找  （必须  ）">
		</div>
	</div>
	<div class="form-group">
		<label for="begintime" class="col-sm-2 control-label">Begin Time:</label>
		<div class="col-sm-8">
		  <input type="text" class="form-control" id="begintime" name="begintime" placeholder="msg的有效开始时间">
		</div>
	</div>
	<div class="form-group">
		<label for="finishtime" class="col-sm-2 control-label">Finish Time:</label>
		<div class="col-sm-8">
		  <input type="text" class="form-control" id="finishtime" name="finishtime" placeholder="msg的有效结束时间">
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
		  <input type="text" class="form-control" id="msginfo" name="msginfo" placeholder="msg的内容">
		</div>
	</div>
	<div class="form-group">
		<label for="msginfo" class="col-sm-2 control-label">Msg Join Channels:</label>
		<div class="col-sm-8">
		  <input type="text" class="form-control" id="joinChannels" name="joinChannels" placeholder="允许渠道 null表示全渠道都可以">
		</div>
	</div>
	<div class="form-group card">
		<label for="f_card_title" class="col-sm-2 control-label">Card Title:</label>
		<div class="col-sm-8">
		  <input type="text" class="form-control" id="f_card_title" name="f_card_title" placeholder="卡片标题">
		</div>
	</div>
	<div class="form-group card">
		...
		<div class="col-sm-8">
		  ...
		  <input type="hidden" class="form-control" id="f_card_img" name="f_card_img">
	...
	<div class="form-group card">
		...
		<div class="col-sm-8">
		  <input type="text" class="form-control" id="f_card_desc" name="f_card_desc" placeholder="卡片描述">
		</div>
	</div>
	<div class="form-group card">
		<label for="f_card_atction" class="col-sm-2 control-label">Card Action:</label>
		<div class="col-sm-8">
		  <input type="text" class="form-control" id="f_card_atction" name="f_card_atction" placeholder="卡片动作">
		</div>
	</div>
	<div class="form-group card">
		<label for="f_card_frominfo" class="col-sm-2 control-label">Card Content:</label>
		<div class="col-sm-8">
		  <input type="text" class="form-control" id="f_card_frominfo" name="f_card_frominfo" placeholder="卡片来自于信息">
		</div>
	</div>
	<div class="form-group card">
		<label for="f_card_finish" class="col-sm-2 control-label">Card Finish:</label>
		<div class="col-sm-8">
		  <input type="text" class="form-control" id="f_card_finish" name="f_card_finish" placeholder="卡片完成内容">
		</div>
	</div>
	<div class="form-group card">
		<label for="f_card_finish_action" class="col-sm-2 control-label">Card Finish Action:</label>
		<div class="col-sm-8">
		  <input type="text" class="form-control" id="f_card_finish_action" name="f_card_finish_action" placeholder="卡片完成动作">
		</div>
	</div>
	<div class="form-group card">
		<label for="f_card_extrc" class="col-sm-2 control-label">Card Extrc:</label>
		<div class="col-sm-8">
		  <input type="text" class="form-control" id="f_card_extrc" name="f_card_extrc" placeholder="卡片扩展">
		</div>
	</div>
