...
class Request {
    ...
    public function setApi($server, $apiName, $opt=array()) {
        $this->url = ServiceApiInfomation::getApiUrl($server, $apiName);
        $this->method = ServiceApiInfomation::getApiMethod($server,$apiName,$opt);
        $this->opt = ServiceApiInfomation::getApiOpt($server,$apiName,$opt);
    }
